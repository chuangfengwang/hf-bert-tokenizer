...
def use_thriftpy2_multi_server_test():
    servers = [('127.0.0.1', 8080)]
    pool_thrifty2 = connection_pool.RandomMultiServerClient(
    ...
    # 可以在中途重新设置 servers
    pool_thrifty2.set_servers(servers)
...
if __name__ == '__main__':
    use_thriftpy2_multi_server_test()
    # use_thriftpy2_test()
    # use_native_test()
