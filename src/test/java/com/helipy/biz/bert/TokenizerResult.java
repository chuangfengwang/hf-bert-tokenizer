...
public class TokenizerResult implements org.apache.thrift.TBase<TokenizerResult, TokenizerResult._Fields>, java.io.Serializable, Cloneable, Comparable<TokenizerResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<String>> tokenizer_word_list; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<Integer>> tokenizer_id_list; // optional
  ...
  public TokenizerResult(
    java.util.List<java.util.List<String>> tokenizer_word_list)
  {
    this();
  ...
  public TokenizerResult(TokenizerResult other) {
    if (other.isSetTokenizer_word_list()) {
      java.util.List<java.util.List<String>> __this__tokenizer_word_list = new java.util.ArrayList<java.util.List<String>>(other.tokenizer_word_list.size());
      for (java.util.List<String> other_element : other.tokenizer_word_list) {
        java.util.List<String> __this__tokenizer_word_list_copy = new java.util.ArrayList<String>(other_element);
    ...
    if (other.isSetTokenizer_id_list()) {
      java.util.List<java.util.List<Integer>> __this__tokenizer_id_list = new java.util.ArrayList<java.util.List<Integer>>(other.tokenizer_id_list.size());
      for (java.util.List<Integer> other_element : other.tokenizer_id_list) {
        java.util.List<Integer> __this__tokenizer_id_list_copy = new java.util.ArrayList<Integer>(other_element);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<String>> getTokenizer_word_listIterator() {
    return (this.tokenizer_word_list == null) ? null : this.tokenizer_word_list.iterator();
  }

  public void addToTokenizer_word_list(java.util.List<String> elem) {
    if (this.tokenizer_word_list == null) {
      this.tokenizer_word_list = new java.util.ArrayList<java.util.List<String>>();
    }
    this.tokenizer_word_list.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<String>> getTokenizer_word_list() {
    return this.tokenizer_word_list;
  }

  public TokenizerResult setTokenizer_word_list(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<String>> tokenizer_word_list) {
    this.tokenizer_word_list = tokenizer_word_list;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<Integer>> getTokenizer_id_listIterator() {
    return (this.tokenizer_id_list == null) ? null : this.tokenizer_id_list.iterator();
  }

  public void addToTokenizer_id_list(java.util.List<Integer> elem) {
    if (this.tokenizer_id_list == null) {
      this.tokenizer_id_list = new java.util.ArrayList<java.util.List<Integer>>();
    }
    this.tokenizer_id_list.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<Integer>> getTokenizer_id_list() {
    return this.tokenizer_id_list;
  }

  public TokenizerResult setTokenizer_id_list(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<Integer>> tokenizer_id_list) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case TOKENIZER_WORD_LIST:
      if (value == null) {
        ...
        setTokenizer_word_list((java.util.List<java.util.List<String>>)value);
      }
      break;
    ...
    case TOKENIZER_ID_LIST:
      if (value == null) {
        ...
        setTokenizer_id_list((java.util.List<java.util.List<Integer>>)value);
      }
      break;
  ...
  public int compareTo(TokenizerResult other) {
    ...
    lastComparison = Boolean.compare(isSetTokenizer_word_list(), other.isSetTokenizer_word_list());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetTokenizer_id_list(), other.isSetTokenizer_id_list());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTokenizer_id_list()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TokenizerResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tokenizer_word_list = new java.util.ArrayList<java.util.List<String>>(_list8.size);
                @org.apache.thrift.annotation.Nullable java.util.List<String> _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  {
                    org.apache.thrift.protocol.TList _list11 = iprot.readListBegin();
                    _elem9 = new java.util.ArrayList<String>(_list11.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tokenizer_id_list = new java.util.ArrayList<java.util.List<Integer>>(_list14.size);
                @org.apache.thrift.annotation.Nullable java.util.List<Integer> _elem15;
                for (int _i16 = 0; _i16 < _list14.size; ++_i16)
                {
                  {
                    org.apache.thrift.protocol.TList _list17 = iprot.readListBegin();
                    _elem15 = new java.util.ArrayList<Integer>(_list17.size);
                    int _elem18;
      ...
      if (struct.tokenizer_id_list != null) {
        if (struct.isSetTokenizer_id_list()) {
          oprot.writeFieldBegin(TOKENIZER_ID_LIST_FIELD_DESC);
          {
            ...
            for (java.util.List<Integer> _iter22 : struct.tokenizer_id_list)
            {
              {
  ...
  private static class TokenizerResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TokenizerResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TokenizerResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.List<String> _iter24 : struct.tokenizer_word_list)
        {
          {
      ...
      if (struct.isSetTokenizer_id_list()) {
        {
          ...
          for (java.util.List<Integer> _iter26 : struct.tokenizer_id_list)
          {
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TokenizerResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.tokenizer_word_list = new java.util.ArrayList<java.util.List<String>>(_list28.size);
        @org.apache.thrift.annotation.Nullable java.util.List<String> _elem29;
        for (int _i30 = 0; _i30 < _list28.size; ++_i30)
        {
          {
            org.apache.thrift.protocol.TList _list31 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            _elem29 = new java.util.ArrayList<String>(_list31.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tokenizer_id_list = new java.util.ArrayList<java.util.List<Integer>>(_list34.size);
