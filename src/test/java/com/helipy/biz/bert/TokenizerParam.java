...
public class TokenizerParam implements org.apache.thrift.TBase<TokenizerParam, TokenizerParam._Fields>, java.io.Serializable, Cloneable, Comparable<TokenizerParam> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<String> text_list; // required
  ...
  public TokenizerParam(
    java.util.List<String> text_list)
  {
    this();
  ...
  public TokenizerParam(TokenizerParam other) {
    ...
    if (other.isSetText_list()) {
      java.util.List<String> __this__text_list = new java.util.ArrayList<String>(other.text_list);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<String> getText_listIterator() {
    return (this.text_list == null) ? null : this.text_list.iterator();
  }

  public void addToText_list(String elem) {
    if (this.text_list == null) {
      this.text_list = new java.util.ArrayList<String>();
    }
    this.text_list.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<String> getText_list() {
    return this.text_list;
  }

  public TokenizerParam setText_list(@org.apache.thrift.annotation.Nullable java.util.List<String> text_list) {
    this.text_list = text_list;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case TEXT_LIST:
      if (value == null) {
        ...
        setText_list((java.util.List<String>)value);
      }
      break;
  ...
  public int compareTo(TokenizerParam other) {
    ...
    lastComparison = Boolean.compare(isSetText_list(), other.isSetText_list());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetWrapper_id(), other.isSetWrapper_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWrapper_id()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TokenizerParam(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.text_list = new java.util.ArrayList<String>(_list0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenizerParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.text_list != null) {
        oprot.writeFieldBegin(TEXT_LIST_FIELD_DESC);
        {
          ...
          for (String _iter3 : struct.text_list)
          {
  ...
  private static class TokenizerParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TokenizerParam> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TokenizerParam struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (String _iter4 : struct.text_list)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TokenizerParam struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.text_list = new java.util.ArrayList<String>(_list5.size);
